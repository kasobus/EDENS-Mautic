...
$catalogue = new MessageCatalogue('en_US', array (
  ...
  array (
    ...
    'mautic.lead.field.form.isuniqueidentifer.tooltip' => 'Set to yes if this field is a unique identifier for the lead (i.e. email, username, social media handle, etc).',
    'mautic.lead.field.form.isuniqueidentifer.warning' => 'WARNING: Inappropriately setting &quot;Is Unique Identifier&quot; to Yes could cause a mass merging of leads and incorrectly tracked lead activity. Only set to Yes if this field tracks a unique value specific to the lead such as email, username, etc.',
    ...
    'mautic.campaign.plugin.leadpush' => 'Push lead',
