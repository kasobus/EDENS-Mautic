...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->aliases = array(
            ...
            'swiftmailer.mailer.default.transport' => 'mautic.transport.amazon',
            ...
            'swiftmailer.transport' => 'mautic.transport.amazon',
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\StaticPHPDriver(array(0 => ($this->targetDirs[2].'/bundles/ApiBundle/Entity'), 1 => ($this->targetDirs[2].'/bundles/AssetBundle/Entity'), 2 => ($this->targetDirs[2].'/bundles/CampaignBundle/Entity'), 3 => ($this->targetDirs[2].'/bundles/CategoryBundle/Entity'), 4 => ($this->targetDirs[2].'/bundles/CoreBundle/Entity'), 5 => ($this->targetDirs[2].'/bundles/EmailBundle/Entity'), 6 => ($this->targetDirs[2].'/bundles/FormBundle/Entity'), 7 => ($this->targetDirs[2].'/bundles/LeadBundle/Entity'), 8 => ($this->targetDirs[2].'/bundles/PageBundle/Entity'), 9 => ($this->targetDirs[2].'/bundles/PluginBundle/Entity'), 10 => ($this->targetDirs[2].'/bundles/PointBundle/Entity'), 11 => ($this->targetDirs[2].'/bundles/ReportBundle/Entity'), 12 => ($this->targetDirs[2].'/bundles/UserBundle/Entity'), 13 => ($this->targetDirs[2].'/bundles/WebhookBundle/Entity')));
        ...
        $d->setEntityNamespaces(array('MauticApiBundle' => 'Mautic\\ApiBundle\\Entity', 'MauticAssetBundle' => 'Mautic\\AssetBundle\\Entity', 'MauticCampaignBundle' => 'Mautic\\CampaignBundle\\Entity', 'MauticCategoryBundle' => 'Mautic\\CategoryBundle\\Entity', 'MauticCoreBundle' => 'Mautic\\CoreBundle\\Entity', 'MauticEmailBundle' => 'Mautic\\EmailBundle\\Entity', 'MauticFormBundle' => 'Mautic\\FormBundle\\Entity', 'MauticLeadBundle' => 'Mautic\\LeadBundle\\Entity', 'MauticPageBundle' => 'Mautic\\PageBundle\\Entity', 'MauticPluginBundle' => 'Mautic\\PluginBundle\\Entity', 'MauticPointBundle' => 'Mautic\\PointBundle\\Entity', 'MauticReportBundle' => 'Mautic\\ReportBundle\\Entity', 'MauticUserBundle' => 'Mautic\\UserBundle\\Entity', 'MauticWebhookBundle' => 'Mautic\\WebhookBundle\\Entity', 'FOSOAuthServerBundle' => 'FOS\\OAuthServerBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_1f96f08f38b0564da427dc3ec725eff86f9ac45fa3eb5102fca474ecfd64d2a3');
        return $instance;
    }
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('Mautic\\AssetBundle\\Entity' => ($this->targetDirs[2].'/bundles/AssetBundle/Entity'), 'Mautic\\CampaignBundle\\Entity' => ($this->targetDirs[2].'/bundles/CampaignBundle/Entity'), 'Mautic\\CategoryBundle\\Entity' => ($this->targetDirs[2].'/bundles/CategoryBundle/Entity'), 'Mautic\\CoreBundle\\Entity' => ($this->targetDirs[2].'/bundles/CoreBundle/Entity'), 'Mautic\\EmailBundle\\Entity' => ($this->targetDirs[2].'/bundles/EmailBundle/Entity'), 'Mautic\\FormBundle\\Entity' => ($this->targetDirs[2].'/bundles/FormBundle/Entity'), 'Mautic\\LeadBundle\\Entity' => ($this->targetDirs[2].'/bundles/LeadBundle/Entity'), 'Mautic\\PageBundle\\Entity' => ($this->targetDirs[2].'/bundles/PageBundle/Entity'), 'Mautic\\PointBundle\\Entity' => ($this->targetDirs[2].'/bundles/PointBundle/Entity'), 'Mautic\\ReportBundle\\Entity' => ($this->targetDirs[2].'/bundles/ReportBundle/Entity'), 'Mautic\\UserBundle\\Entity' => ($this->targetDirs[2].'/bundles/UserBundle/Entity'), 'Mautic\\WebhookBundle\\Entity' => ($this->targetDirs[2].'/bundles/WebhookBundle/Entity')));
    ...
    protected function getMautic_Transport_AmazonService()
    {
        ...
        $instance->setUsername('kylesobus@live.com');
        $instance->setPassword('Carly407');
        return $instance;
    }
    ...
    {
        return $this->services['oneup_uploader.templating.uploader_helper'] = new \Oneup\UploaderBundle\Templating\Helper\UploaderHelper($this->get('router'), array('asset' => 33554432));
    }
    ...
    {
        return $this->services['session.storage.native'] = new \Symfony\Component\HttpFoundation\Session\Storage\NativeSessionStorage(array('name' => '687bde5d113017f6e0199806ede8fcbc', 'gc_probability' => 1), NULL, $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['swiftmailer.mailer.default'] = new \Swift_Mailer($this->get('mautic.transport.amazon'));
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('d6723f9fc3adcf2bb272e8a30a20b6a0808249825defdadecaa0b39b8be3ec28');
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->setConstraintValidatorFactory(new \Symfony\Bundle\FrameworkBundle\Validator\ConstraintValidatorFactory($this, array('validator.expression' => 'validator.expression', 'Symfony\\Component\\Validator\\Constraints\\EmailValidator' => 'validator.email', 'security.validator.user_password' => 'security.validator.user_password', 'doctrine.orm.validator.unique' => 'doctrine.orm.validator.unique', 'oauth_callback' => 'mautic.validator.oauthcallback', 'leadlist_access' => 'mautic.validator.leadlistaccess', 'uniqueleadlist' => 'mautic.lead.constraint.alias')));
    ...
    {
        return $this->services['router.request_context'] = new \Symfony\Component\Routing\RequestContext('/EDENS%20Mautic', 'GET', 'localhost', 'http', 80, 443);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mautic.db_table_prefix' => 'mautic_',
            'mautic.db_path' => NULL,
            'mautic.locale' => 'en_US',
            ...
            'mautic.mailer_from_name' => 'Kyle Sobus',
            'mautic.mailer_from_email' => 'ksobus@edens.com',
            'mautic.mailer_return_path' => NULL,
            'mautic.mailer_transport' => 'mautic.transport.amazon',
            'mautic.mailer_host' => NULL,
            'mautic.mailer_port' => NULL,
            'mautic.mailer_user' => 'kylesobus@live.com',
            'mautic.mailer_password' => 'Carly407',
            ...
            'kernel.secret' => 'd6723f9fc3adcf2bb272e8a30a20b6a0808249825defdadecaa0b39b8be3ec28',
            ...
            'session.storage.options' => array(
                'name' => '687bde5d113017f6e0199806ede8fcbc',
                'gc_probability' => 1,
            ),
            ...
            'swiftmailer.mailer.default.transport.name' => 'mautic.transport.amazon',
            'swiftmailer.mailer.default.delivery.enabled' => true,
            'swiftmailer.mailer.default.transport.smtp.encryption' => NULL,
            'swiftmailer.mailer.default.transport.smtp.port' => 25,
            'swiftmailer.mailer.default.transport.smtp.host' => NULL,
            'swiftmailer.mailer.default.transport.smtp.username' => 'kylesobus@live.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'Carly407',
            ...
            'doctrine_migrations.table_name' => 'mautic_migrations',
